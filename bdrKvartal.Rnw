...
## sykYear <- Data %>%
##     select(Year, regValg, AlderKat3) %>%  #inn_Type == regValg
##     filter(Year >=lastyr, regValg !=3) %>%
##     group_by(regValg, Year, AlderKat3) %>%
##     tally
