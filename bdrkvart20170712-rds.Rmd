...
pakke <- c("nbReg", "data.table", "dplyr", "ggplot2", "tidyr", "grid", "knitr", "xtable")
inspak(pakke)
...
## filnavn <- "avid.RDS"
## RegData <- read.csv(filnavn, sep = ";", stringsAsFactors = FALSE, fileEncoding = "latin1")
## RegData <- fread("File.csv")
