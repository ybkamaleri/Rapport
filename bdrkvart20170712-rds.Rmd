...
pakke <- c("data.table", "dplyr", "ggplot2", "tidyr", "grid", "knitr", "xtable")
inspak(pakke)
...
dataNorge <- RegData[innYear %between% c(paste0(DatoFra), paste0(DatoTil)), ]
